    ...
    if (isset($_POST['action']) && $_POST['action'] == 'searchPeca' && isset($_POST['term'])) {
        ...
        if ($resultado->num_rows > 0) {
            while ($row = $resultado->fetch_assoc()) {
                ...
                echo "<td><input class='peca-qtd' type='text'></input></td>";
                echo "<td><button class='select-peca button-icon' data-id='" . $row['id'] . "' data-qtd=''>Adicionar</button></td>";
                echo "</tr>";
            }
        } else {
...
<body>
    ...
    <div id="editModal" class="modal hidden">
        <div class="modal-content">
            ...
            <div class="grid-template" id="editForm">
